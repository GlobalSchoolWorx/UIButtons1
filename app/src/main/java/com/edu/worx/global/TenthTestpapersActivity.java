...
public class TenthTestpapersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = findViewById(R.id.tenth_toolbar);
        if (toolbar != null) {
        ...
        if (verticalOrientation) {
              ...
              parms = new LinearLayout.LayoutParams((int) getPixel(200f), (int) getPixel(screenTopMargin / 2.0));
        }
        else {
                parmsFirst = new LinearLayout.LayoutParams((int) getPixel(200f), (int) getPixel(screenTopMargin / 2));
                parms = new LinearLayout.LayoutParams((int) getPixel(200f), (int) getPixel(screenTopMargin / 2.0));
        ...
        if(subjectArray.length > 4)
            ...
            parmsFirst.topMargin = (int)(getPixel(screenTopMargin/1.5)) + 500;

        parmsFirst.leftMargin = (int) getPixel(screenLeftMargin) - 300;
        ...
        for (int i = 0; i < subjectArray.length; i++) {
                ...
                if (!verticalOrientation && (i > subjectArray.length / 2))
                    ...
                    parms.leftMargin = (int) getPixel(screenLeftMargin) - 300;
