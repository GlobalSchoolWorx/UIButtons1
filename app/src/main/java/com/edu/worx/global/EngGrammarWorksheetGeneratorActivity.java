...
public class EngGrammarWorksheetGeneratorActivity extends AppCompatActivity {
    ...
    public void createDynamicLayout (ArrayList<String> mParams) {
        ...
        topButton.setText("Generate Worksheet");
        ...
        tvTitle.setText("TOPIC : " + mParams.get(2));
        ...
        ll.addView(tv);
        String str =  mParams.get(0) + "EngSubTopicIndex/" + mParams.get(1)+ "/" + mParams.get(2);
        DatabaseReference masterDbReference = FirebaseDatabase.getInstance().getReference(str);
        ...
        ValueEventListener valueEventListener = q.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if ( counter > 6) {
                   topButton.setPadding(20,20,20,40);
