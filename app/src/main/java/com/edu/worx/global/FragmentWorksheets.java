...
public class FragmentWorksheets extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (verticalOrientation) {
            parmsFirst = new LinearLayout.LayoutParams((int) getPixel(200f), (int) getPixel(screenTopMargin / 3));
            parms = new LinearLayout.LayoutParams((int) getPixel(200f), (int) getPixel(screenTopMargin / 3));
        }
        else {
            parmsFirst = new LinearLayout.LayoutParams((int) getPixel(200f), (int) getPixel(screenTopMargin / 2));
            parms = new LinearLayout.LayoutParams((int) getPixel(200f), (int) getPixel(screenTopMargin / 1.5));
        }

        parmsFirst.topMargin = (int)(getPixel(screenTopMargin));
        parmsFirst.leftMargin = (int) getPixel(screenLeftMargin) - 100;
        ...
        if (subjectArray.length == 0)
          ...
          for (int i = 0; i < subjectArray.length; i++) {
            ...
            if (!verticalOrientation && (i > subjectArray.length / 2))
                ...
                parms.leftMargin = (int) getPixel(screenLeftMargin) - 100;
            }
            ...
            myButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra(DisplaySubjectsActivity.SELECTED_CLASS, selectedClassSubject);
